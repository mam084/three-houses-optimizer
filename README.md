...
- [x] **Class base-stat floor applied at every tier, live-updating mix-and-match projections, Hero's Relics as a scoring input, mount/armor-aware weapon-switch warnings, Dancer as a single roster-wide slot, house-colored portraits, and growth-rate visualization on the Character Optimizer tab itself** *(this release)*
